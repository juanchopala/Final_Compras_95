...
public class Variables1 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTCategorias.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTCategoriasActionPerformed(evt);
            }
        });
        jTCategorias.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTCategoriasKeyTyped(evt);
            }
        });
        ...
        jTMetodo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTMetodoKeyTyped(evt);
            }
        });
        ...
        jTNuevoDato.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTNuevoDatoKeyTyped(evt);
            }
        });
        ...
        jTNuevoMetodo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTNuevoMetodoKeyTyped(evt);
            }
        });
    ...
    private void jBModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBModificarActionPerformed
        ...
        if (nuevoDato.trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Llenar campos para modificar");
        } else {
    ...
    private void jTCategoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTCategoriasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTCategoriasActionPerformed

    private void jTCategoriasKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTCategoriasKeyTyped

        if (!(Character.isLetter(evt.getKeyChar()))) {
            evt.consume();
        }
        if (jTCategorias.getText().length() == 20) {
            evt.consume();
        }
    }//GEN-LAST:event_jTCategoriasKeyTyped

    private void jTMetodoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTMetodoKeyTyped
        if (!(Character.isLetter(evt.getKeyChar()))) {
            evt.consume();
        }
        if (jTMetodo.getText().trim().length() == 20) {
            evt.consume();
        }


    }//GEN-LAST:event_jTMetodoKeyTyped

    private void jTNuevoMetodoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTNuevoMetodoKeyTyped
        if (!(Character.isLetter(evt.getKeyChar()))) {
            evt.consume();
        }
        if (jTNuevoMetodo.getText().length() == 20) {
            evt.consume();
        }

    }//GEN-LAST:event_jTNuevoMetodoKeyTyped

    private void jTNuevoDatoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTNuevoDatoKeyTyped
        if (!(Character.isLetter(evt.getKeyChar()))) {
            evt.consume();
        }
        if (jTNuevoDato.getText().length() == 20) {
            evt.consume();
        }
    }//GEN-LAST:event_jTNuevoDatoKeyTyped
